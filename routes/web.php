...
Route::middleware(['auth'])->group(function () {
  ...
  Route::middleware(['guru'])->group(function () {
    ...
    Route::resource('/detail_ulangan', 'DetailUlanganController');
  ...
  Route::middleware(['admin'])->group(function () {
    ...
    Route::get('/detail_ulangan-kelas', 'DetailUlanganController@create')->name('ulangan-kelas');
    Route::get('/detail_ulangan-siswa/{id}', 'DetailUlanganController@edit')->name('ulangan-siswa');
    Route::get('/detail_ulangan-show/{id}', 'DetailUlanganController@ulangan')->name('ulangan-show');
